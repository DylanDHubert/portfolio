...
import { routes, display, person, about, blog, work, gallery, music, library, writing, chart } from "@/resources";
              ...
              {routes["/writing"] && (
                <>
                  <ToggleButton
                    ...
                    data-selected={pathname.startsWith("/writing")}
                  />
                  <ToggleButton
                    className={`s-flex-show ${styles.glowyNavButton}`}
                    href="/writing"
