---
title: "HHB AI Systems – Medical Device Documentation AI"
summary: "AI-powered system that transforms complex medical device documentation into intelligent, searchable data for field representatives and trainees."
...
HHB AI Systems is an AI-powered system that transforms complex medical device documentation into intelligent, searchable data for field representatives and trainees. Built by Dylan Hubert, Luke Heitman, and Alex Bull, our system addresses the critical challenge of making dense technical documentation accessible to sales teams in high-stakes environments like operating rooms.
...
### **Current Status**
- **Early testing** with select medical tech companies
- **Operating room sales teams** as primary users
- **Medical device documentation** as initial dataset
- **Domain-agnostic architecture** designed for expansion
- **Project** actively developed by the team

### **Target Impact**
- **Significant reduction** in time to find technical information
...
---
*This project is actively developed by the team. For more info, visit the [demo](https://hhblandingpage.vercel.app) or contact the team.* 